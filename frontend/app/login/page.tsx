...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // For demo purposes, redirect to parent dashboard
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Log in to manage your bookings and connect with sitters.
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/5 via-accent/10 to-secondary items-center justify-center p-12">
        <div className="max-w-lg text-center">
          <div className="mb-8 flex justify-center">
            <div className="h-48 w-48 rounded-3xl bg-card shadow-2xl flex items-center justify-center border border-border/50">
              <span className="text-8xl">👨‍👩‍👧‍👦</span>
            </div>
          </div>
          <h2 className="text-2xl font-serif text-foreground mb-4">
            Welcome back to your trusted childcare community
          </h2>
          <p className="text-muted-foreground">
            Access your bookings, message sitters, and manage your family&apos;s care schedule all in one place.
          </p>
        </div>
      </div>
    </div>
